    ...
    <div class="container">
      <div class="row">
        <div class="col-md-9" role="main">
          <div class="main" [scrollSpyIndex]="{id: 'terms', selector: 'anchor'}">
            <div>
              <h2 id="home" class="anchor">Terms</h2>
              ...
              <h3 id="legal" class="anchor">Legal</h3>
              ...
              <h3 id="regulations" class="anchor">Regulations</h3>
              ...
              <h3 id="violation" class="anchor">Violation</h3>
        ...
        <div class="col-md-3" role="complementary">
          <scrollSpy-index-render
            [scrollSpyIndexRenderOptions]="{id: 'terms', spyId: 'window', topMargin: 90}"
